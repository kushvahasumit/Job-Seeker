        ...
        <div className="grid gap-[4rem] grid-cols-3 items-center">
          <div className="singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem]  shadow-lg shadow-greyIsh-400/700 hover:shadow-lg">
            ...
            <p className="text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold">
              In comparison to other employment portals, what stuck out for me
              was that, in addition to giving genuinely fantastic prospects,
              Coursify also assisted me in talks with the firms.
            </p>
          </div>
          ...
          <div className="singleGrid rounded-[10px] hover:bg-[#f7edf5] p-[1.5rem]  shadow-lg shadow-greyIsh-400/700 hover:shadow-lg">
            ...
            <p className="text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold">
              Coursify was able to make the procedure really simple. They were
              able to book interviews with the best companies in the field and
              ensured that the entire process ran well.
            </p>
          </div>
          ...
          <div className="singleGrid rounded-[10px] hover:bg-[#fcfae3] p-[1.5rem]  shadow-lg shadow-greyIsh-400/700 hover:shadow-lg">
            ...
            <p className="text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold">
              When I was looking for fresh prospects, a friend of mine told me
              about Coursify. The team was really helpful, professional, and

...
export default function JobPage() {
    //   const [jobType, setJobType] = useState(''); // Initialize state for the input value

  const handleChange = (event) => {
    // setJobType(event.target.value); // Update the state with the input value
  };
  return (
    <div>
      <div className="job">
        ...
        value={jobType} // Set the value of the input to the state value
